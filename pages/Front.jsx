    ...
    <div className="front-wrapper">
      <div className="front-container">
        ...
        <div className="sidebar">
          ...
          <a href="#sponsors" className="sidebar-item">
            <div className="sidebar-icon">
              <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
            </div>
            <span className="sidebar-label">SPONSORS</span>
          </a>
          <a href="#store" className="sidebar-item">
            ...
            <span className="sidebar-label">STORE</span>
          </a>
        </div>
        ...
        >
          <img src="/images/200.PNG" alt="Background Left" />
        </motion.div>
        ...
        >
          <img src="/images/201.PNG" alt="Background Right" />
        </motion.div>
        ...
        <div className="main-content">
          ...
          >
            ...
            >
              <img src="/images/2.png" alt="Event Logo" className="main-logo-img" />
            </motion.div>
